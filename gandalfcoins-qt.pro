TEMPLATE = app
TARGET = gandalfcoins-qt
macx:TARGET = "GandalfCoins-Qt"
VERSION = 1.0.0
...
BOOST_INCLUDE_PATH=C:/boost_1_57_0
BOOST_LIB_PATH=C:/boost_1_57_0/stage/lib
BDB_INCLUDE_PATH=c:/db-4.8.30.NC/build_unix
BDB_LIB_PATH=c:/db-4.8.30.NC/build_unix
OPENSSL_INCLUDE_PATH=c:/openssl-1.0.1l/include
OPENSSL_LIB_PATH=c:/openssl-1.0.1l
